...
#NorESM dir
noresmrepo="ctsm5.4.042_noresm_v1_FATES_sci4" 
noresmversion="ctsm5.4.042_noresm_v1"

resolution="ne16pg3_tn14" #f19_g17, ne30pg3_tn14, f45_f45_mg37, ne16pg3_tn14 
casename="ihist.$resolution.$noresmversion.CPLHIST_Scenario_H_BRANCH_olv.`date +"%Y-%m-%d"`"
...
refcase="ihist.ne16pg3_tn14.ctsm5.4.042_noresm_v1.CPLHIST_Scenario_H_olv.2026-06-25"
...
then
    ...
    then
        ...
        sed -i 's/sci.1.92.5_api.46.0.0_nor_sci3_api2/sci.1.92.5_api.46.0.0_nor_sci4_api2/g' .gitmodules
        echo "Updated .gitmodules to use sci.1.92.5_api.46.0.0_nor_sci4_api2:"
...
then
	...
	./xmlchange RUN_REFDIR=/cluster/work/projects/nn9560k/kjetisaa/noresm/$refcase/run/
	...
	./xmlchange DRV_RESTART_POINTER=rpointer.cpl.$startdate-00000
...
cat <<EOF >> user_nl_clm
 ...
 fluh_timeseries = '/cluster/work/projects/nn9560k/inputdata//lnd/clm2/surfdata_esmf/ctsm5.4.0/fates_LU_data_CMIP7/LUH3_timeseries_2022-2100_H_surfdata_ne16np4_c260624.nc'
EOF
...
then
    ...
    cp /cluster/work/projects/nn9560k/kjetisaa/noresm/$refcase/run/*.r*.nc /cluster/work/projects/nn9560k/kjetisaa/noresm/$casename/run/
    cp /cluster/work/projects/nn9560k/kjetisaa/noresm/$refcase/run/rpointer.*$refyear-01-01-00000 /cluster/work/projects/nn9560k/kjetisaa/noresm/$casename/run/
