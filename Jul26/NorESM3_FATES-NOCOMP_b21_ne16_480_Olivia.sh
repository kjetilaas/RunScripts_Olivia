...
#NorESM dir
noresmrepo="NorESM_3_0_beta21"
noresmversion="noresm3_0_beta21"
runTag="i480"

resolution="ne16pg3_tn14" #f19_g17, ne30pg3_tn14, f45_f45_mg37
casename="n1850.$resolution.$noresmversion.$runTag.`date +"%Y-%m-%d"`"
...
then
    ...
    then    
        ...
        ./xmlchange NTASKS=1536,NTASKS_OCN=500,ROOTPE_OCN=1536,ROOTPE_LND=0
	./xmlchange RUN_TYPE=hybrid
        ...
        ./xmlchange HAMOCC_SEDSPINUP=TRUE
	./xmlchange HAMOCC_SEDSPINUP_YR_END=1125
...
cat <<EOF >> user_nl_clm
fates_paramfile = '/cluster/work/projects/nn9560k/jessica/smort_param_files/fates_params_noresm_c260615_vhsmort_increasebmort.json'
finidat='/cluster/work/projects/nn9560k/kjetisaa/archive/n1850.ne16pg3_tn14.noresm3_0_beta19.Run15-E.Olivia.2026-06-18/rest/1751-01-01-00000/n1850.ne16pg3_tn14.noresm3_0_beta19.Run15-E.Olivia.2026-06-18.clm2.r.1751-01-01-00000.nc'
hist_fincl1 = 'FATES_LITTER_BG_CWD_EL', 'FATES_VEGC_PF', 'FATES_STRUCTC', 'FATES_CROWNAREA_PF', 'TOTSOMC', 'TOT_WOODPRODC', 'CROPPROD1C'
EOF

cat <<EOF >> user_nl_blom
SWAMTH = 'chlorophyll_ohl03'
CE = 0.09
CVMIX_LSCALAR_CV = .true.
CVMIX_RI_CRIT = .25
wlin = 0.01
remido = 0.0025
EOF
...
#    cp /cluster/work/projects/nn9560k/kjetisaa/archive/$refcase/rest/$refyear-01-01-00000/$refcase.cam.i.$refyear-01-01-00000.nc /cluster/work/projects/nn9560k/kjetisaa/noresm/$casename/run/
     cp /cluster/work/projects/nn9560k/inputdata/restart_ne16/$refcase/$refyear-01-01-00000/*.r*.nc /cluster/work/projects/nn9560k/kjetisaa/noresm/$casename/run/ 
     cp /cluster/work/projects/nn9560k/inputdata/restart_ne16/$refcase/$refyear-01-01-00000/rpointer.*$refyear-01-01-00000 /cluster/work/projects/nn9560k/kjetisaa/noresm/$casename/run/ 
     cp /cluster/work/projects/nn9560k/inputdata/restart_ne16/$refcase/$refyear-01-01-00000/$refcase.cam.i.$refyear-01-01-00000.nc /cluster/work/projects/nn9560k/kjetisaa/noresm/$casename/run/
echo "copied restart files and pointers"i
fi
